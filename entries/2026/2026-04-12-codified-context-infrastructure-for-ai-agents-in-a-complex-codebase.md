...
- **Scaling guidance**: Empirical data separates what must stay in always-on context from what should be retrieved. It gives concrete published guidance for cross-session memory in a large codebase.
