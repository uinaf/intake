...
Spec-Driven Development treats a living spec plus conformance tests as the primary artifact, so coding agents can produce the implementation instead of humans shipping code first.
