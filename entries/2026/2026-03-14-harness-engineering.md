...
- **Legible environment**: Initializer, feature-list JSON with pass/fail, commits and progress so a fresh session can catch up.
- **Repo as record**: AGENTS.md as a table of contents; if the agent cannot access it, it does not exist.
