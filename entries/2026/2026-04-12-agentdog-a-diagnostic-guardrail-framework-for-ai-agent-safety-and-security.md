...
- **Root-cause safety**: Monitoring asks why a constraint was violated, where it originated, and what downstream consequences follow. This helps when audit trails need more than a binary flag.
